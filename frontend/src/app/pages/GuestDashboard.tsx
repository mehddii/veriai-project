            ...
            >
              <div className="grid gap-6 xl:grid-cols-[minmax(0,1.04fr)_minmax(320px,0.96fr)]">
                <div className="flex flex-col">
                  ...
                  <div className="mt-6 grid gap-5 lg:grid-cols-[minmax(0,1.1fr)_minmax(220px,0.9fr)]">
                    <div className={`rounded-[1.8rem] border p-4 ${inkCard}`}>
                    ...
                    <div className={`rounded-[1.8rem] border p-4 ${inkCard}`}>
                      <div className={`text-[11px] uppercase tracking-[0.18em] ${textMuted}`}>At a glance</div>
                      <div className="mt-4 space-y-4">
                        {[
                          ...
                          <div key={item.label} className="flex items-start justify-between gap-4 border-b border-slate-200/70 pb-3 last:border-b-0 last:pb-0 dark:border-white/10">
                            <div className={`text-[11px] uppercase tracking-[0.16em] ${textMuted}`}>{item.label}</div>
                            <div className="text-right text-[14px] font-semibold text-blue-700 dark:text-blue-200">{item.value}</div>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="mt-3 space-y-3">
                      {[
                        ...
                        <div key={note} className="flex items-start gap-3">
                          <DrawingPinIcon className="mt-1 h-3.5 w-3.5 shrink-0 text-blue-600" />
